    ...
    // console.log(moduleData);
     ...
     useEffect(() => {
        ...
        async function fetchArray() {
            ...
            //23/11/2024
            try {
                const queryParams = new URLSearchParams({ userName,l1:l1.l1.l1module,userPower });
            ...
            //     const response = await fetch(`/api/fetchCombinedData?${queryParams}`)
            //     console.log(response);
    ...
    return (
        <div className="rfp-table">
            <div className="header">
                <div className="title">
                    {/* <span>RFP No: {sidebarValue && rfp_no}  </span>
                    <span>RFP Title: {sidebarValue && rfp_title}</span> */}
                </div>
            </div>
            ...
            <button onClick={() => handleSave({ module: itemData, items: FItem,
                rfp_no:sidebarValue[0].rfp_no,rfp_title:sidebarValue[0].rfp_title})}>Submit</button>
